...
ssh_priv_key.add_argument('-T', dest='creds_key', help='Private key')
...
if __name__ == '__main__':
    ...
    if options['sub_command'] == 'ssh-private-key':
        if options['creds_key_file'] and options['creds_key_src'] and options['creds_key']:
            print 'Specify either key file or key source'
        if not (options['creds_key_file'] or options['creds_key_src'] or options['creds_key']):
